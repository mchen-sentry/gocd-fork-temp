...
RUN chown -R go:root /docker-entrypoint.d /go-working-dir /godata /docker-entrypoint.sh /cron && \
    chmod -R g=u /docker-entrypoint.d /go-working-dir /godata /docker-entrypoint.sh /cron
